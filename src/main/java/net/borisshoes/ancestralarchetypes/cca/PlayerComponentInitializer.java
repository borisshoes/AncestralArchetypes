...
public class PlayerComponentInitializer implements EntityComponentInitializer {
   public static final ComponentKey<IArchetypeProfile> PLAYER_DATA =
         ComponentRegistryV3.INSTANCE.getOrCreate(Identifier.of(MOD_ID, "profile"), IArchetypeProfile.class);
